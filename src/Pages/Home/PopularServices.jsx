...
const PopularServices = () => {
  return (
    <div className="w-11/12 mx-auto my-10">
      <h2 className="text-4xl font-bold mb-6 text-primary">Popular Services</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service, idx) => (
          <div
            key={idx}
            className={`rounded-xl p-4 shadow-md bg-primary text-secondary hover:scale-105 transition-transform duration-300`}
          >
